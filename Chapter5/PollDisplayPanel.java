 ...
 * @version (11/8/21)
 * keeps track of poll counts and displays numbers and as a pie chart
 */
 ...
 public PollDisplayPanel(String nm1, String nm2, String nm3)
 {
  ...
  private void drawPieChart(Graphics g, int x, int y, int r)
  {
    ...
    if (total > 0)
    {
      ...
      drawSector(g, x, y, r, 360 - fromDegree, degrees);
    }
    else
    {
  ...
  private void drawLegend(Graphics g, int x, int y, int r)
  {
    ...
    //g.drawString(this.count1, x - r, y);

    //g.drawString(this.count2, x, y);

    //g.drawString(this.count3, x + r, y);
